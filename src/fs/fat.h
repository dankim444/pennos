 ...
 *         Returns FAT_EOF if the index is invalid or the file system is not mounted.
 */
 ...
 * All file operations work with this block size as the basic unit of allocation.
 *
