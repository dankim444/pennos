 ...
 * Purpose: Defines the structures, definitions, and functions for PennFAT
 * routines.
 */
 ...
 *
 * This function initializes a new PennFAT filesystem with the specified
 * parameters. The number of blocks in the FAT ranges from 1 through 32, and the
 * block size is determined by block_size (0=256B, 1=512B, 2=1024B, 3=2048B,
 * 4=4096B).
 *
 ...
 *
 * This function loads the filesystem's FAT into memory for subsequent
 * operations. Only one filesystem can be mounted at a time.
 *
 ...
 *
 * This function reads the content of files and writes it to stdout or to
 * another file. It supports reading from stdin when no input files are
 * specified.
 *
 * Usage formats:
