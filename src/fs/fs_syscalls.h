 ...
 *                - SEEK_SET (0): The offset is set relative to the start of the file.
 *                - SEEK_CUR (1): The offset is set relative to the current position.
 *                - SEEK_END (2): The offset is set relative to the end of the file.
 *
