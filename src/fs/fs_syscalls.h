...
////////////////////////////////////////////////////////////////////////////////
//                     FILE SYSTEM MODE FLAGS                                 //
////////////////////////////////////////////////////////////////////////////////

/**
 * F_WRITE: Open file for writing. Creates the file if it doesn't exist.
 * If the file exists, it will be truncated to zero length unless F_APPEND is also specified.
 */
 #define F_WRITE 1

 /**
  * F_READ: Open file for reading. The file must exist.
  */
 #define F_READ 2
 
 /**
  * F_APPEND: Open file for appending. Writes occur at the end of the file.
  * Must be used with F_WRITE.
  */
 #define F_APPEND 4
