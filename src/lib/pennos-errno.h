...
#define P_NULL 10  // Undesired NULL output
#define P_READ 11 // Interrupted READ call
#define P_LSEEK 12 // Interrupted LSEEK call
#define P_MAP 13 // Interrupted MAP call
#define P_EFUNC 14 // Error comes from a custom function
